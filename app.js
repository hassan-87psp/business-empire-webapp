...
/* ===================== INIT ===================== */
window.__BUSINESS_EMPIRE_APP_VERSION='12.0.0';
(async function init(){
  try{
...
if('serviceWorker'in navigator){window.addEventListener('load',()=>{navigator.serviceWorker.register('./service-worker.js?v=12').then(reg=>reg.update()).catch(err=>console.warn('[Business Empire] service worker failed:',err))})}
