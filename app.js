...
if('serviceWorker'in navigator){window.addEventListener('load',()=>{navigator.serviceWorker.register('./service-worker.js?v=10').then(reg=>reg.update()).catch(err=>console.warn('[Business Empire] service worker failed:',err))})}
